 ...
 * be converted to RGB.
 *   <li> CV_CAP_PROP_WHITE_BALANCE_U The U value of the whitebalance setting
 * (note: only supported by DC1394 v 2.x backend currently)
 *   <li> CV_CAP_PROP_WHITE_BALANCE_V The V value of the whitebalance setting
 * (note: only supported by DC1394 v 2.x backend currently)
 *   <li> CV_CAP_PROP_RECTIFICATION Rectification flag for stereo cameras (note:
 * only supported by DC1394 v 2.x backend currently)
 *   <li> CV_CAP_PROP_ISO_SPEED The ISO speed of the camera (note: only
 * supported by DC1394 v 2.x backend currently)
 *   <li> CV_CAP_PROP_BUFFERSIZE Amount of frames stored in internal buffer
